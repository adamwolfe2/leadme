          ...
          <div className="mt-2 h-1.5 bg-zinc-100 rounded-full overflow-hidden">
            <div
              className={`h-full rounded-full transition-all ${
                ...
                dailyRemaining !== null && dailyRemaining <= 5 ? 'bg-amber-500' : 'bg-emerald-500'
              }`}
              style={{
          ...
          <div className="p-4 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-10 px-3 text-sm border border-zinc-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-violet-500"
              />
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={addKeyword}
                  className="px-4 h-10 text-sm font-medium text-violet-600 border border-violet-300 rounded-lg hover:bg-violet-50"
                >
                  Add
                </button>
              </div>
              {filters.keywords.length > 0 && (
                <div className="mt-2 flex flex-wrap gap-2">
                  {filters.keywords.map(keyword => (
                    <span
                      key={keyword}
                      className="inline-flex items-center gap-1 px-2 py-1 text-sm bg-violet-100 text-violet-700 rounded-md"
                    >
                      {keyword}
                      <button onClick={() => removeKeyword(keyword)} className="hover:text-violet-900">
                        <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 text-sm rounded-full border transition-colors ${
                      filters.industries.includes(industry)
                        ...
                        : 'bg-white text-zinc-700 border-zinc-300 hover:border-violet-400'
                    }`}
                  >
                    {industry}
                  </button>
        ...
        <div className="p-4 bg-zinc-50 border-t border-zinc-200">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-medium text-white bg-violet-600 rounded-lg hover:bg-violet-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {searchMutation.isPending ? (
                <>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3">
                      <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-violet-500 to-purple-600 rounded-lg flex items-center justify-center text-white font-semibold">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-2 py-1 text-xs font-medium bg-zinc-100 text-zinc-600 rounded-full">
                      {lead.provider === 'datashopper' ? 'DataShopper' : 'AudienceLabs'}
                    </span>
                  </div>
                </div>
                {lead.email && (
