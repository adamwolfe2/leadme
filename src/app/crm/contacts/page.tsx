              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1.5">
                    Manage your contacts and decision makers
                  </p>
                </div>
              ...
              <div className="h-full rounded-lg border border-blue-100/50 bg-white/80 backdrop-blur-sm p-8">
                ...
                <div className="flex flex-col items-center justify-center h-full">
                  ...
                  <p className="text-sm text-muted-foreground text-center max-w-md mb-6">
                    Build your network by adding contacts. Track conversations, relationships, and
                  ...
                  <div className="mt-12 w-full max-w-3xl space-y-3">
                    ...
                    {Array.from({ length: 5 }).map((_, i) => (
                      ...
                      >
                        <div className="shimmer-cursive h-10 w-10 rounded-full" />
                        <div className="flex-1 space-y-2">
                          <div className="shimmer-cursive h-4 w-40 rounded" />
                          <div className="shimmer-cursive h-3 w-56 rounded" />
                        </div>
                        <div className="shimmer-cursive h-6 w-24 rounded-full" />
