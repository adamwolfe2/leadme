...
export function GoogleSheetsIntegration({ workspaceId, isPro }: GoogleSheetsIntegrationProps) {
  ...
  const handleConnect = () => {
    if (!isPro) {
      alert('Google Sheets integration requires a Pro plan. Please upgrade to continue.')
      return
    }
    setConnecting(true)
  ...
  const handleDisconnect = () => {
    if (confirm('Are you sure you want to disconnect Google Sheets? Your export configuration will be removed.')) {
