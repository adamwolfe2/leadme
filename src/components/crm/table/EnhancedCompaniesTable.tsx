...
export function EnhancedCompaniesTable({
  ...
  }, [data, searchQuery, statusFilter, industryFilter])
            ...
            <DropdownMenuContent align="end" className="w-48">
              ...
              {INDUSTRY_OPTIONS.map((industry) => (
                <DropdownMenuCheckboxItem
                  ...
                  onCheckedChange={(checked) => setIndustryFilter(checked ? industry : 'all')}
                >
                  {industry}
                </DropdownMenuCheckboxItem>
              ))}
            ...
            {paginatedCompanies.length === 0 ? (
              ...
              paginatedCompanies.map((company) => (
                ...
                >
                  ...
                  <TableCell>
                    <Badge variant="outline" className={cn('text-xs border', getStatusColor(company.status))}>
                      {company.status}
                    </Badge>
                  </TableCell>
