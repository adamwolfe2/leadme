...
const statusColors: Record<LeadStatus, { bg: string; text: string; ring: string; dot: string }> = {
  ...
  won: { bg: 'bg-blue-50', text: 'text-blue-700', ring: 'ring-blue-200', dot: 'bg-blue-500' },
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
              ...
              <textarea
                ...
                className="mt-4 w-full rounded-lg border border-zinc-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                rows={3}
              />
              <div className="mt-4 flex gap-3">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    pendingStatus === 'won' ? 'bg-blue-600 hover:bg-blue-700' : 'bg-red-600 hover:bg-red-700',
