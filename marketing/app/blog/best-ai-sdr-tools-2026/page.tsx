        ...
        <MachineContent>
          <MachineSection title="Best AI SDR Tools for 2026: 9 Platforms Ranked">
            ...
            <MachineSection title="Related Pages">
              <MachineList items={[
                { label: "Cursive AI SDR Platform", href: "/platform" },
                { label: "What Is an AI SDR?", href: "/blog/what-is-ai-sdr" },
                { label: "Visitor Identification", href: "/visitor-identification" },
                { label: "Apollo vs Cursive Comparison", href: "/blog/apollo-vs-cursive-comparison" },
              ]} />
            </MachineSection>
          </MachineSection>
        </MachineContent>
